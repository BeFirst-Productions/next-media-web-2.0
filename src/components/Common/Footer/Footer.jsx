          ...
          <div className="md:col-span-4 flex flex-col space-y-8 md:space-y-12">
            <div className="flex flex-col space-y-6">
              ...
              <div className="flex flex-col space-y-4">
                <a href="tel:+971588984455" className="flex items-center space-x-3 text-white hover:text-[#00A3FF] transition-colors group">
                  ...
                  <span className="text-base font-medium">+971 58 898 4455</span>
                </a>
            ...
            <div className="flex flex-row md:flex-col items-center md:items-end gap-4 md:gap-5 self-start md:self-end pr-0 md:pr-4">
              {/* Instagram */}
              <a href="https://www.instagram.com/nextdigital.ae" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-[46px] h-[46px] rounded-full border-[1.5px] border-[#2bc5ee] flex items-center justify-center hover:bg-[#2bc5ee] text-white hover:text-white transition-all">
              ...
              {/* LinkedIn */}
              <a href="https://in.linkedin.com/company/nextdm" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-[46px] h-[46px] rounded-full border-[1.5px] border-[#2bc5ee] flex items-center justify-center hover:bg-[#2bc5ee] text-white hover:text-white transition-all">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/nextdms" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-[46px] h-[46px] rounded-full border-[1.5px] border-[#2bc5ee] flex items-center justify-center hover:bg-[#2bc5ee] text-white hover:text-white transition-all">
