    ...
    <section className="relative w-full pt-16 pb-10 md:pt-24 md:pb-32 bg-black overflow-hidden">
      <Container>
        <div className="flex flex-col ">
          {/* Heading */}
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-semibold text-white text-center mb-16 tracking-tight leading-tight max-w-7xl mx-auto animate-fade-in-up">
            {title} <span className="text-[#00B4D8]">{highlight}</span> {titleSuffix}
            <span className="inline-block ml-4 align-middle">
              <svg width="32" height="42" viewBox="0 0 27 25" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 md:w-auto">
