...
export default function HeroMarquee({ marqueeTranslate, marqueeProgress, dropProgress = 0 }) {
  return (
    ...
    >
      <h1 className="text-[12vw] sm:text-[10vw] font-bold whitespace-nowrap flex items-center space-x-4 sm:space-x-8 px-10 leading-normal drop-shadow-2xl mix-blend-overlay overflow-visible">
        
        <span className="bg-linear-to-b from-white to-gray-500 bg-clip-text text-transparent pb-6 inline-block">
          Dream big
        </span>
        ...
        <span className="bg-linear-to-b from-white to-gray-500 bg-clip-text text-transparent ml-8 pb-6 inline-block">
          Develop better
        </span>
      </h1>
    </div>
